...
export function useWorkspaceManager({ onMessage }: Options) {
  ...
  return {
    ...
    requestDeleteLibraryEntry: libraryBrowser.requestDeleteEntry,
    pendingDeleteLibraryEntry: libraryBrowser.pendingDeleteEntry,
    deletingLibraryEntry: libraryBrowser.deleting,
    confirmDeleteLibraryEntry: libraryBrowser.confirmDeleteEntry,
    cancelDeleteLibraryEntry: libraryBrowser.cancelDeleteEntry,
